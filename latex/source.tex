...
\begin{document}
    ...
    \begin{titlepage}
        \begin{center}
            \center{
            \includegraphics[scale=0.7]{up_logo}
            }
            ...
            \textgreek{
                \huge
                \textbf{Παράλληλοποίηση προσεγγιστικής αριθμητικής λύσης διαφορικών εξισώσεων}
            }
            \\
            \Large{\textbf{
                A parallel approach for numerical IVP solutions using polynomial approximation error minimisation}
            }
            \vspace{1cm}
            ...
            \vspace{-0.3cm}
            \begin{center}
                Δερματάς Ευάγγελος    Κοσμόπουλος Δημήτριος
            \end{center}
            }
...
%    Shifting out focus to the more specific problem of training neural ODEs.
    ...
    \begin{figure}[H]
        \begin{center}
            \resizebox{\textwidth}{!}{ \input{moons.pgf} }
        \end{center}
    ...
    \begin{figure}[H]
        \begin{center}
            \resizebox{\textwidth}{!}{ \input{moons_sol.pgf} }
        \end{center}
